...
- **当前状态（2026-08-28）**：已完成 GUI 所需接口、组件、主题、布局、i18n 以及插件 editor sidecar/字段描述的前置合同盘点，尚未开始编码；下一步进入 P13-0，先抽取 CLI/GUI 共用的结构化 `tools/project` 深模块并落地 editor 资源 loader，门禁通过后才进入 P13-1 窗口壳。
