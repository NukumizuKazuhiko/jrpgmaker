...
- **范围与阶段**：详见 [编辑器 GUI 计划](08-editor-plan.md)，按 P13-1 编辑器壳、P13-2 文档模型与诊断、P13-3 schema-aware 表单、P13-4 地图/材质/插件扩展、P13-5 只读预览与发布回归推进。
...
- **当前状态（2026-08-28）**：已完成 P13 合同和实施计划登记，尚未开始编码；下一步进入 P13-1，只建立独立编辑器壳与只读工作区。
