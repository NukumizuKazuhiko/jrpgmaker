...
- **当前状态（2026-08-29）**：P13-0 已开始编码。`engine/ui` 已落地独立 editor manifest/locale/layout 值对象与 bounded loader，覆盖 schema、id、locale namespace、重复布局 id、CJK UTF-8 文本和布局节点上界；Windows 定向测试 4/4 通过。`tools/project` 工作区 seam、默认/高对比主题资源和实际 editor 窗口仍未完成，暂不进入 P13-1。
